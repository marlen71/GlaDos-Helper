...
from .speech_text import prepare
...
class SileroTTS(BaseTTS):
    ...
    def synth(self, text: str) -> np.ndarray:
        # Silero — русская модель: латиницу она молча пропускает,
        # поэтому переводим её в кириллицу по произношению
        text = prepare(text)
